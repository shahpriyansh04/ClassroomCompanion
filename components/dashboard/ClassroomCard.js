...
function ClassroomCard() {
  return (
    <div className="bg-gray-100 rounded-lg shadow-lg h-60 w-10/12 flex-grow mx-auto mb-6 flex flex-col justify-start items-center  active:scale-95 transition duration-150 ease-in">
      <div className="w-full ">
        <div className="flex items-center justify-between cursor-pointer">
          <p className="text-2xl mt-4 text-center ml-6">Class Name</p>{" "}
      ...
      <div className="flex items-center justify-between  flex-grow space-x-6 ">
        <div className="flex px-2 py-2 rounded-lg flex-col border-2 border-black cursor-pointer">
          <BiHomeAlt className="h-8" size="lg" />
        </div>
        <div className="flex px-2 py-2 rounded-lg flex-col border-2 border-black cursor-pointer">
          <BsFileEarmarkText className="h-8" size="lg" />
        </div>{" "}
        <div className="flex px-2 py-2 rounded-lg flex-col border-2 border-black cursor-pointer">
          <BiSpreadsheet className="h-8" size="lg" />
        </div>
      </div>
